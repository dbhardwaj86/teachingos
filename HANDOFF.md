...
> - **▶ NEXT: the first GUI-driven throughput run** at `/` (Publish app): Plan → Approve seed → Build all → Publish, verified at `/learn`. Then the combinedDBQues question-bank rewire (directive above) and Phase F (the heavy async LLM lanes) per DEC-9's ratified ordering.
>
> ---
>
